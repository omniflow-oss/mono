...
const runTask = (taskName, extra = []) => run("task", [taskName, ...extra]);
...
const isBackScope = (s) => s.startsWith("back/services/") || s.startsWith("back/libs/");
const isFrontScope = (s) => s.startsWith("front/apps/") || s.startsWith("front/packages/");
